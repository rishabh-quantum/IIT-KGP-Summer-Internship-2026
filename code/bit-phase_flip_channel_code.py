"""
Bit-Phase flip Channel code using Qiskit
"""
...
#-----Random Bit-Phase Flip Probability-----

p = np.random.rand()
print("Bit-Phase Flip Probability p =", f"{p:.6f}")
...
ax2.set_title(f"Bit-Phase flip Channel (p = {p:.4f})")
