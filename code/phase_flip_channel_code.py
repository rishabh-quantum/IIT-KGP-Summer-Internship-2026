"""
Phase-flip Channel code using Qiskit
"""
...
#-----Random Phase Flip Probability-----

p = np.random.rand()
print("Phase Flip Probability p =", f"{p:.6f}")
...
ax2.set_title(f"Phase-flip Channel (p = {p:.4f})")
